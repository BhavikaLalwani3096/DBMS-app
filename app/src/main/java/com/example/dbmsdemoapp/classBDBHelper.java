...
public class classBDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "ClassBDB.db";
    public static final String TABLE_NAME = "TYCSEB";
    ...
    public classBDBHelper(Context context) {
